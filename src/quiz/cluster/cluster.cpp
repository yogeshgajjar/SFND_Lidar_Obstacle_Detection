...
void clusterTemp(int id, std::vector<int> &cluster, const std::vector<std::vector<float>>& points, float distanceTol, KdTree* tree, std::vector<bool> points_processed) {
